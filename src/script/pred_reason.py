...
def main():
    prompt = [
        '''
        Argument 1:\n{arg1}\n\nArgument 2:\n{arg2}\n\nThe discourse relation between Argument 1 and Argument 2 can be\nA. Comparison\nB. Contingency\nC. Expansion\nD. Temporal\n\nYour task is to figure out the relation. Do not output the answer and just output the short and simple reason of the answer.
        '''.strip(),
        '''
    ...
    sample_args = ReasoningArgs(
        version='gpt3_5.pdtb3.pred_l1.reason',  # !!! TODO !!!
        prompt=prompt,
